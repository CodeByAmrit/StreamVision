    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        doc
          ...
          .fontSize(11)
          .font("Helvetica-Bold")
          .text("Visual Operating Status", 65, currentY + 15);
        ...
        doc
          ...
          .fontSize(18)
          .font("Helvetica-Bold")
          .text(`${activeCams}`, 440, currentY + 45, { width: 85, align: "center" });
        doc
          .fillColor("#4b5563")
          .fontSize(7.5)
          .font("Helvetica-Bold")
          .text("ACTIVE NODES", 440, currentY + 68, { width: 85, align: "center" });
        doc
          .fillColor("#111827")
          .fontSize(12)
          .font("Helvetica-Bold")
          .text(`${healthPercent}%`, 440, currentY + 82, { width: 85, align: "center" });
        ...
        doc
          ...
          .font("Helvetica-Bold")
          .fillColor("#111827")
          .text("Intelligent Performance Insights");
        doc.moveDown(0.5);
        doc
          .fontSize(10)
          .font("Helvetica")
          ...
          .lineGap(3)
          .text(
            `Forensic audit via Loki detected ${data.criticalErrors || 0} critical signatures. System health at ${successPercent}% indicates professional SLA targets are being maintained for ${timeframe}.`
          );
        ...
        if (data.alerts && data.alerts.length > 0) {
          doc
            ...
            .fillColor("#d97706")
            .font("Helvetica-Bold")
            .text("Detected Operational Deviations:", { underline: true });
          ...
          doc
            ...
            .font("Helvetica-Bold")
            .text(
              "\u2714 Audit Complete: Global operational success verified across all streaming zones."
            );
        }
        ...
        doc
          ...
          .fillColor("#6b7280")
          .text(
            "This report is an executive performance summary. For deep forensic logs and real-time telemetry, authorized personnel should refer to the StreamVision command console.",
            { lineGap: 2 }
          );
